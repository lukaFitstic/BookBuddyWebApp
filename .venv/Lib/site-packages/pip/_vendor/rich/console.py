...
class Console:
    ...
    def set_window_title(self, title: str) -> bool:
        ...
        ``fish`` shell resets the window title before and after each commands by default,
        negating this issue. Windows Terminal and commands prompt will also reset the title for you.
